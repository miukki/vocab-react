...
https://expo.io/@miukki/vocabsmith  
...
```
docker build -t vocab-app-expo .
docker run --name vocab-expo -p 19000-19300:19000-19300 vocab-app-expo
```
...
```
cp config.js.staging config.js
```
...
#### Debug hints, If you need remove Learned Words
```
window.Expo.SecureStore.deleteItemAsync('studyPlan')
```
...
2. Add the Genymotion tools directory to your path (instructions for [Mac](http://osxdaily.com/2014/08/14/add-new-path-to-path-command-line/)
